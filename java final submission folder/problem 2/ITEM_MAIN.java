...
public boolean addproduct() throws IOException
    {
        ...
        if (pos==-1) 
        {
            ...
            System.out.println("Unique Product code is: " + icode);
        }
        else
        {
            ...
            switch(ch1)
            {
           	...
           	case 1: 
                 ...
                 case 2:
                 	...
                 	System.out.print("Please enter the Unique Code of the product: ");
                        name=br.readLine();
